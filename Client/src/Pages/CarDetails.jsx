    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                 ...
                 transition={{delay:0.2, duration:0.5}} >
                    ...
                    <div>
                        ...
                        <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                            {
                                ["360 Camera", "Blueooth", "Navigation System", "Rear View Mirror"].map((item)=> (
            ...
            onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
                ...
                <p className='flex items-center justify-center text-2xl text-gray-800 font-semibold'>{currency}{car.pricePerDay}<span className='text-base text-gray-400 font-normal'>per day</span></p>
                ...
                <p className='text-center text-sm mt-4'>No credit card required to reserve</p>
